...
class ResourceManagerAgent extends BaseAgentImpl {
  ...
  Stream<ResourceUpdate> get resourceUpdates => _resourceUpdateController.stream;
  ...
  /// Win/loss ratio
  double get winLossRatio => _totalLosses == 0 ? _totalWinnings : _totalWinnings / _totalLosses;
