        ...
        <div class="analysis-grid">
                ...
                <div class="quality-score">
                    ...
                    <div class="score-details">
                        <div class="score-item">
                            ...
                            <span class="value ${result.blindSpots.isNotEmpty ? 'text-red-400' : 'text-green-400'}">${result.blindSpots.length}</span>
                        </div>
                        <div class="score-item">
            ...
            <div class="analysis-card glass-card">
                ...
                <div class="issues-list">
                    <div class="issue-item ${result.blindSpots.isNotEmpty ? 'critical' : 'resolved'}">
                        <i class="fa-solid fa-${result.blindSpots.isNotEmpty ? 'circle-exclamation' : 'circle-check'}"></i>
                        <span class="issue-text">${result.blindSpots.length} Blind Spots</span>
                        <span class="issue-severity">${result.blindSpots.length > 5 ? 'High' : result.blindSpots.isNotEmpty ? 'Medium' : 'None'}</span>
                    </div>
